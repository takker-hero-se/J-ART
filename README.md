...
本リポジトリは Zenodo にアーカイブされ、DOI が発行されています。引用には
**concept DOI（常に最新版を指す）`10.5281/zenodo.20676879`** を、特定版を固定する場合は
version DOI `10.5281/zenodo.20676880`（v0.1.0）を使用してください。
レコード: <https://zenodo.org/records/20676880>。引用メタデータは
[CITATION.cff](CITATION.cff) と [.zenodo.json](.zenodo.json) にあります。
